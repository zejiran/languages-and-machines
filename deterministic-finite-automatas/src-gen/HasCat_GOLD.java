// DO NOT EDIT THIS FILE! IT IS AUTOMATICALLY GENERATED FROM FILE "src/HasCat_GOLD.gold"
import gold.*;
...
public final class HasCat_GOLD {
  static {
  ...
  public static void main(String[] args) {
    ...
    $try:try {
      $line=3;
      GAutomataFrame.show($cast(gold.structures.automaton.IAutomaton.class,HasCat_GOLD.createAutomaton()));
      $line=4;
      Utilities.test($cast(gold.structures.automaton.IAutomaton.class,HasCat_GOLD.createAutomaton()));
    }
    catch (Throwable $throwable) {
      $rethrow($throwable,HasCat_GOLD.class,"main",$line);
    }
  }
  public static Object getName() {
    ...
    $try:try {
      ...
      $rethrow($throwable,HasCat_GOLD.class,"getName",$line);
    }
    return $result;
  }
  public static IAutomaton createAutomaton() {
    ...
    $try:try {
      ...
      $rethrow($throwable,HasCat_GOLD.class,"createAutomaton",$line);
    }
